...
export default function PreviouslySold() {
  ...
  const handleCategoryFilter = (category: string | null) => {
    ...
    const newUrl = `/previously-sold${params.toString() ? '?' + params.toString() : ''}`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Showcase of quality cars we've successfully sold to satisfied customers - demonstrating our commitment to excellence
            </p>
          </div>
              ...
              {(searchQuery || selectedCategory) && (
                <Button
                  ...
                  onClick={() => {
                    setSearchQuery("");
                    setSelectedCategory(null);
                    window.history.pushState({}, '', '/previously-sold');
                  }}
                >
                  Clear Filters
                </Button>
